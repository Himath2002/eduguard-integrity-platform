...
async function setupCommunicationHarness(
  ...
  await page.setContent(`
    ...
    <html>
      <head>
        <meta charset="utf-8" />
        <title>Integration Communication E2E Harness</title>
        <style>
          body {
            margin: 0;
      ...
      <body>
        ...
        <script>
          ...
          function renderDetail() {
            ...
            const thread = currentDetail.thread;
          ...
          async function boot() {
            ...
            try {
              ...
              document.getElementById("error").innerHTML = '<div class="error">' + escapeHtml(error.message || "Communication service unavailable") + '</div>';
            }
          }
...
test.describe("Integration and Communication E2E workflow", () => {
